  ...
  return (
    <div className="w-[100%] flex justify-between">
        <div className="w-[29%] h-[100%] flex flex-col">
            <div onClick={Pay} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[5px] cursor-pointer rounded-sm ${payment ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
            ...
            <div onClick={Voucher} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer rounded-sm ${voucher ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
				    <RiCouponLine />
			    </div>
            ...
            <div onClick={Return} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer  rounded-sm ${refund ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
				    <svg className={`ml-[-13px] ${refund ? 'fill-white' : "fill-[#000]"}`} width="46" height="46" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
			    ...
			    <div className='font-medium  text-[15px] ml-[7px]'>Returns & Refunds</div>
		    </div>
            
            <div onClick={Delivery} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer rounded-sm ${delivery ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
...
<path d="M24.064 22.8895C23.5284 20.9516 23.2612 19.9821 23.7162 19.2191C24.17 18.4549 25.1693 18.1954 27.168 17.6753L29.2881 17.1254C31.2868 16.6064 32.2861 16.3459 33.0734 16.7864C33.8607 17.2281 34.1291 18.1965 34.6635 20.1356L35.2322 22.1916C35.7677 24.1296 36.0361 25.0991 35.5811 25.8632C35.1262 26.6262 34.1269 26.8868 32.1282 27.4058L30.0081 27.9568C28.0094 28.4758 27.0101 28.7353 26.2228 28.2947C25.4354 27.853 25.1682 26.8846 24.6327 24.9467L24.064 22.8895Z" stroke="black" stroke-width="1.24226"/>
            ...
            <div onClick={Account} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer rounded-sm ${account ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
				    <svg className={`ml-[-13px] ${account ? 'fill-white' : "fill-[#000]"}`} width="54" height="54" viewBox="0 0 54 54" fill="" xmlns="http://www.w3.org/2000/svg">
<path d="M17.9219 36.4581V35.3539C17.9219 31.6948 20.8882 28.7285 24.5473 28.7285H28.9642C32.6233 28.7285 35.5896 31.6948 35.5896 35.3539V36.4581" stroke="black" stroke-width="1.65635" stroke-linecap="round"/>
<path d="M26.7607 25.4159C24.3213 25.4159 22.3438 23.4384 22.3438 20.999C22.3438 18.5596 24.3213 16.582 26.7607 16.582C29.2 16.582 31.1776 18.5596 31.1776 20.999C31.1776 23.4384 29.2 25.4159 26.7607 25.4159Z" stroke="black" stroke-width="1.65635" stroke-linecap="round"/>
                    </svg>
			    </div>
			    <div className='font-medium  text-[15px] ml-[7px] '>Account</div>
		    </div>
            <div onClick={Agent} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer rounded-sm ${agent ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
				    <MdPayment />
			    </div>
			    <div className='font-medium  text-[15px] ml-[20px] '>Become an agent</div>
		    </div>
            <div onClick={Sell} className={`w-full min-h-[45px] flex justify-start  items-center pl-[20px] mb-[7px] cursor-pointer rounded-sm ${sell ? 'bg-secondary text-white' : 'bg-[#de801c4f] text-[#000]'}`}>
			    <div className='text-[20px]  font-bold'>
				    <MdPayment />
			    </div>
        ...
        {payment ? (
            <div className="w-[68%] flex h-[100%] flex-col">
        ...
        {voucher ? (
            <div className="w-[68%] flex h-[100%] flex-col bg-[blue]">Voucher</div>
        ) : null}
        {refund ? (
            <div className="w-[68%] flex h-[100%] flex-col bg-[blue]">Refund</div>
        ) : null}
        {delivery ? (
            <div className="w-[68%] flex h-[100%] flex-col bg-[blue]">Delivery</div>
        ) : null}
        {account ? (
            <div className="w-[68%] flex h-[100%] flex-col bg-[blue]">Account</div>
        ) : null}
        {agent ? (
            <div className="w-[68%] flex h-[100%] flex-col bg-[blue]">Become an agent</div>
        ) : null}
        {sell ? (
            <div className="w-[68%] flex h-[100%] flx-col bg-[blue]">Sell on KAO</div>
        ) : null}
    </div>
  )
}
