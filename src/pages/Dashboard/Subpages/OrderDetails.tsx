...
const OrderDetails = () => {
  return (
    <div className="w-[100%] sm:items-center flex flex-col mt-[25px] pb-[30px]">
        ...
        <div className="w-[100%] sm:w-[90%] flex justify-between mt-[20px]">
        ...
        <div className="flex flex-col mt-[25px] sm:w-[90%]">
        ...
        <div className="flex flex-col mt-[25px] sm:w-[90%]">
            ...
            <div className="sm:mt-[35px] flex items-center text-[14px] font-[500] mt-[7px] sm:w-[100%] sm:flex-wrap"><h3 className="w-[100%] sm:text-[15px] sm:font-[600]">Delivery Address:</h3><div className="flex flex-col ml-[4px]">
