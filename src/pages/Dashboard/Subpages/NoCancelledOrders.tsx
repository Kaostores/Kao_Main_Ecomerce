...
const NoCancelledOrders = () => {
  return (
    <div className='w-[100%] h-[100%] flex justify-center items-center flex-col pt-[70px]'>
        ...
        <p className='mt-[40px] font-[600] text-[20px] md:text-[18px] sm:text-[14px]'>You have no Cancelled Orders</p>
    </div>
  )
}

export default NoCancelledOrders