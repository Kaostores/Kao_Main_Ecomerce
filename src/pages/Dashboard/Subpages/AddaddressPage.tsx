...
const AddaddressPage: React.FC<Iprops> = ({ actionType, addrData }) => {
    ...
    <>
        {actionType === "edit" && (
				<form
					...
					className='xl:w-[400px] md:w-[350px] sm:w-[100%] mx-auto mt-[20px]'>
					<div className='mb-5'>
						<label
							htmlFor='fullname'
            ...
            {actionType === "new" && (
				<form
					...
					<div className='flex mb-[20px] items-center'>
						<div className='text-[20px] mr-5 cursor-pointer'>
							<IoMdArrowBack />
						</div>
