...
const TrackSteps = ({ currentStep }: { currentStep: any }) => {
	const [steps] = useState({
		stepsCount: [1, 2, 3, 4],
		currentStep: statusToStep[currentStep] || 1, // Map status to step number
	});

	console.log("this is the current step", steps.currentStep);

	return (
		<div className='max-w-lg  px-4 md:px-0 sm:px-0 h-[300px]'>
			<ul aria-label='Steps' className='flex flex-col items-center'>
