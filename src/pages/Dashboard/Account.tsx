...
const Account = () => {
  ...
  return (
    <>
      ...
      <div className="w-[100%] flex-col sm:items-center p-[15px] sm:p-0 bg-[#F4F4F4] rounded-[8px] sm:ml-0 sm:bg-white">
      <h3 className="font-[500] sm:hidden">Account Overview</h3>

        <div onClick={() => Navigate(-1)} className="w-[100%] justify-center items-center hidden sm:flex">
      ...
      <div className="w-[100%] sm:items-center flex flex-col mt-[15px] sm:mt-[30px]">
      ...
      <div className="w-[100%] flex flex-col mt-[25px] sm:items-center">
        <div className="items-center sm:flex hidden sm:mb-[20px] sm:w-[90%]"><div className="text-primary"><MdModeEditOutline /></div><h3 className="text-primary text-[13px] sm:font-[600] font-[500] ml-[5px]">Change Address</h3></div>
          ...
          <div className="w-[100%] sm:w-[90%] flex items-center justify-between">
          ...
          <h3 className="mt-[10px] sm:w-[90%] font-[500]">Temiloluwa Morafa</h3>
          <h3 className="mt-[8px] font-[500] sm:w-[90%]">No 6, Alafia street, Olota, Surulere, Lagos State.</h3>
      </div>
      ...
      <div className="w-[100%] flex flex-col mt-[25px] sm:items-center">
        <div onClick={Toggle3} className="items-center sm:flex hidden sm:mb-[20px] sm:w-[90%] cursor-pointer"><div className="text-primary"><MdModeEditOutline /></div><h3 className="text-primary text-[13px] sm:font-[600] font-[500] ml-[5px]">Change Password</h3></div>
          ...
          <h3 className="mt-[10px] font-[500] sm:w-[90%]">****************</h3>
      </div>
    </div>
       <div className="w-[90%]">
        <Recomended />
