...
function Calendar({
	...
	return (
		<DayPicker
			...
			classNames={{
				months: "flex  sm:flex-col space-y-4 sm:space-x-4 sm:space-y-0",
				month: "space-y-4",
				...
				day_selected:
					"bg-secondary text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
				day_today:
					"bg-secondary text-slate-900 dark:bg-slate-800 dark:text-slate-50",
				day_outside:
